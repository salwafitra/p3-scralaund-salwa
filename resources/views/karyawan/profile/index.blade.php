        ...
        <div class="card">
            <div class="card-body">
                <div class="col text-center">
                    <div class="m-t-30">
                      <img class="round" src="{{asset(Auth::user()->foto == null ? 'backend/images/profile/logouser.png' : 'storage/images/foto_profile/'. Auth::user()->foto )}}" alt="avatar" height="150" width="150">

                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item">
                          <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            <span>
                              <img class="round" src="{{asset(Auth::user()->foto == null ? 'backend/images/profile/logouser.png' : 'storage/images/foto_profile/'. Auth::user()->foto )}}" alt="avatar" height="40" width="40">
                            </span>
                          </a>
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="{{url('home')}}">
                        ...
                        <h2 class="brand-text mb-0">SCRALAUND</h2>
                    </a></li>
